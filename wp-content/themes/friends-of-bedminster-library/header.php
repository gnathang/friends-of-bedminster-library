...
<body class="scrollbar-hidden"<?php body_class(); ?>>
<?php wp_body_open(); ?>
	...
	<header id="masthead" class="site-header">
		<div class="container">
			<div id="header-container" class="header-container">
				...
				<a id="logo-container" class="logo-container" href="<?php echo get_home_url(); ?>">
					<img id="logo" class="logo home-logo" src="<?php echo get_template_directory_uri().'/assets/home-header-logo.svg'?>"/>
					<!-- <h1 class="title"><?php bloginfo('name'); ?></h1> -->
				</a>
			
				<nav id="site-navigation" class="site-menu site-menu-home">
					<?php wp_nav_menu(); ?>
				</nav>
